...
@section('title','MAC Capital - International Debt Solutions')
@section('description', 'MAC Capital specializes in mobilizing private external risk capital by creating the right product to')
@section('keywords', 'Finance, financial, financial solutions, MAC mumbai, Indian stock market and economy, International Debt Solutions')
            ...
            <div class="col-lg-12">
               <div class="breadcrumbs creote">
                  <ul class="breadcrumb m-auto">
                     ...
                     <li class="active">International Debt Solutions</li>
                  </ul>
               </div>
            </div>
         </div>
               ...
               <article class="clearfix service type-service status-publish has-post-thumbnail hentry">
                    <div class="title_all_box style_one dark_color">
                        <div class="title_sections left ">
                            <h1 class="title">International Debt Solutions</h1>
                            <div class="pd_bottom_10"></div>
                            <div class="blog_feature_image">
                                <img src="{{asset('fronted/mac-image/financial-services/international-debt-solutions.jpg')}}" class="wp-post-image" alt="International Debt Solutions">
                            </div>
